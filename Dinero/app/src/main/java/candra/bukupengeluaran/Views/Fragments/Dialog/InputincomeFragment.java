package com.trinet.dinero.Views.Fragments.Dialog;
...
import com.trinet.dinero.Supports.Utils.CurrencyTextWatcher;
import com.trinet.dinero.databinding.FragmentInputIncomeBinding;

/**
 * Created by Aadithyan Rajesh on 07/10/2017.
 */

public class InputincomeFragment extends android.support.v4.app.DialogFragment implements View.OnClickListener {

    FragmentInputIncomeBinding content;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        content = DataBindingUtil.inflate(inflater, R.layout.fragment_input_income, container, false);
