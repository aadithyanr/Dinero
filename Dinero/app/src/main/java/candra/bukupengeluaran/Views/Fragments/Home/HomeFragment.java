...
import com.trinet.dinero.Entities.Model.QuoteModel;
import com.trinet.dinero.Entities.Model.Quotes;
...
import com.trinet.dinero.Modules.OnInputPemasukanListener;
import com.trinet.dinero.Modules.OnInputPengeluaranListener;
import com.trinet.dinero.R;
import com.trinet.dinero.Modules.Presenter.ParseImagePresenter;
import com.trinet.dinero.Supports.Data.DBHelper;
...
import com.trinet.dinero.Supports.Utils.SimpleViewAnimator;
import com.trinet.dinero.Supports.Utils.StaticVariable;
import com.trinet.dinero.Views.Fragments.CalendarFragment;
import com.trinet.dinero.Views.Fragments.Dialog.InputincomeFragment;
import com.trinet.dinero.Views.Fragments.Dialog.InputspendingFragment;
import com.trinet.dinero.Views.ViewHolders.TransaksiViewHolder;
import com.trinet.dinero.databinding.FragmentHomeBinding;
...
//        content.containerListIncome.setAnimationRes(R.anim.slide_down, R.anim.slide_up);
    ...
    private void loadDataPengeluaran(long millis){
        ...
        Adapter<TransaksiModel, TransaksiViewHolder> adapter = new Adapter<TransaksiModel, TransaksiViewHolder>(R.layout.item_transaction,
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == content.fabTambah.getId()){
            ...
            InputspendingFragment fragment = new InputspendingFragment();
            fragment.show(getChildFragmentManager(), "payment");
        }else if (v.getId() == content.fabIncome.getId()){
            InputincomeFragment fragment = new InputincomeFragment();
