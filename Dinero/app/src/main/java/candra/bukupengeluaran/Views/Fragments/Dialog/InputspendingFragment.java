...
import com.trinet.dinero.databinding.FragmentInputSpendingBinding;

/**
 * Created by Aadithyan Rajeshon 06/10/2017.
 */

public class InputspendingFragment extends DialogFragment implements View.OnClickListener {

    FragmentInputSpendingBinding content;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        content = DataBindingUtil.inflate(inflater, R.layout.fragment_input_spending, container, false);
